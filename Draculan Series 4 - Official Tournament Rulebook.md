# **Draculan Series 4 \- Official Tournament Rulebook**
...
**Event Name:** Draculan Series 4 \- Counter-Strike 2 Open LAN
...
**Dates:** December 17 \-\> 21, 2025 (Wednesday–Sunday)  
...
Sign-ups close automatically on **December 3, 2025 at 23:59 (Bucharest time)**.
...
The seeding shall be based on the official VRS ranking released by Valve on **December 1, 2025**. This seeding is applied regardless of whether a registered team is in the VRS top 12, as the restriction on inviting top 12 teams applies only to closed or direct invitation formats, not to open sign-up events. The remaining registered teams will begin in the Open LAN Group Stage on Day 1 to earn their place in the Main Event.  
...
Each group will contain exactly one team from each pot. The live draw will be held on **December 4**, and broadcast on the official **Draculan Kick.com channel \-** [https://kick.com/draculancs](https://kick.com/draculancs) .
...
* **Game Version:** Counter-Strike 2 (latest updated version on Steam by December 17\) will be used for all matches and will not change, regardless of game updates. 
...
* **Voice Communication:** A local TeamSpeak server will be provided and hosted on the tournament network for teams to use. During matches, all voice communication must take place through approved local software or in-game systems.
...
Teams withdrawing within **14 days of the event (after December 3, 2025\)** are not eligible for any refund, regardless of circumstance. 
...
Let’s make this a memorable event for everyone:  players, viewers, and staff alike. **Good luck & have fun to all teams, and welcome to Draculan Series 4\!**
